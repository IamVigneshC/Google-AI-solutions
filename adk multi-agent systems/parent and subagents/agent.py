...
attractions_planner = Agent(
    ...
    instruction="""
        - Provide the user options for attractions to visit within their selected country.- When they reply, use your tool to save their selected attraction
...
root_agent = Agent(
    ...
    instruction="""
        ...
        or If they need help deciding, send them to
        'travel_brainstormer'.
